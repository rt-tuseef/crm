...
$mod_strings = array(
    ...
    'ERR_UW_UPLOAD_ERR' => 'Une erreur s\'est produite lors du téléchargement du fichier. Veuillez réessayer!<br>' . PHP_EOL,
    ...
    'LBL_UW_COMMIT_ADD_TASK_OVERVIEW' => 'Veuillez utiliser la méthode de comparaison la plus connue pour fusionner ces fichiers. Jusqu\'à ce que cela soit terminé, votre installation CRMsera dans un état incertain, et la mise à niveau incomplète.',
    'LBL_UW_COMPLETE' => 'Terminér',
    ...
    'LBL_UW_START_DESC2' => 'Remarque : Nous recommandons fortement que vous créez une copie de l’instance que vous utilisez dans la production et tester le paquet de mise à niveau avant de déployer la nouvelle version. Si vous avez modifié le fichier "composer.json", s’il vous plaît exécuter, une fois le processus de mise à niveau terminée :<br/><br/><pre>composer install --no-dev</pre>', // Keep the <pre>composer install --no-dev</pre> words at the end of the sentence and do not translate it
    ...
    'ERROR_PHP_VERSION_INCOMPATIBLE' => 'Le fichier téléchargé n’est pas compatible avec cette version PHP: ',
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'Le fichier uploadé est incompatible avec cette version de SuiteCRM:',
    ...
    'ERROR_NO_VERSION_SET' => 'Version compatible n’est pas définie dans le fichier manifeste',
    'LBL_UPGRD_CSTM_CHK' => 'Le processus de mise à niveau mettra à jour certains fichiers mais ces fichiers existent également dans custom / folder. S\'il vous plaît examiner les changements avant de continuer:',
    ...
    'LBL_PASSWORD_EXPIRATON_CHANGED' => 'Attention: l\'expiration du mot de passe n\'est pas définie!',
    'LBL_PASSWORD_EXPIRATON_REDIRECT' => 'Veuillez mettre à jour vos paramètres ici',
);
